...
import com.example.salesleads.ui.home.HomeCompanyFragment

class DatabaseHandler(fragment: HomeCompanyFragment) : SQLiteOpenHelper(fragment.requireContext(), DB_NAME, null, DB_VERSION) {
    companion object {
